...
<body>
    ...
    <div class="newstable-main">
        <div class="ContactUs-header">
            ...
            <div class="header-nav"><a href="/AlarmPlatForm/index.action?id=1">主页></a><a href="/AlarmPlatForm/index.action?id=7" class="onactive">数据动态</a></div>
        </div>
    ...
    <script src="/AlarmPlatForm/js/pageJson.js" type="text/javascript" charset="utf-8"></script>
    <script>
     $(function(){
        pages("/AlarmPlatForm/news/data30_DataQualityList.action");
     })
