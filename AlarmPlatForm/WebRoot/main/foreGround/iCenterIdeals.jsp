       ...
       <div class="leftbar_top"><h3>平台简介</h3></div>
        ...
        <div class="CenterP-right">
            <div class="CenterP-right-header">
                ...
                <div class="header-nav"><a href="/AlarmPlatForm/skip.action?pageName=1">主页></a><a href="/AlarmPlatForm/skip.action?pageName=2">平台简介></a><a href="/AlarmPlatForm/skip.action?pageName=22" class="onactive">共享理念</a></div>
            </div>
