			...
			<div class="warp">
				...
				<div class="nav">
					<ul id="nav-ul">
						...
						<c:if test="${sessionScope.userType != '1'}"><li class="active"><a href="/DataShare/login.action?id=4">个人中心</a></li></c:if>
						<c:if test="${sessionScope.userType == '1'}"><li class="active"><a href="/DataShare/login.action?id=4">用户中心</a></li></c:if>
		...
		<div class="main">
			<div class="main-wap">
				...
				<div class="shop">
					...
					<div class="shop-left">
						<!--  ==陆态数据==  -->
                        <ul class="shop-left-ul sidebar usercenter">
                        
                            <c:if test="${sessionScope.userType != '1'}"><li  class="add"><a href="javascript:;">个人中心</a></li></c:if>
						    <c:if test="${sessionScope.userType == '1'}"><li  class="add"><a href="javascript:;">用户中心</a></li></c:if>
							
							<ul class="subnav" style="display: block;" id="wei">
								<li class="u02"><a href="javascript:;" rel="/DataShare/querUserSelfToJsp.action?applyTitle=用户信息">用户信息</a></li>
								<li class="u03"><a href="javascript:;" rel="/DataShare/docInfoListToJsp.action?applyTitle=用户成果管理">用户成果管理</a></li>
								<li class="u04"><a href="javascript:;" rel="/DataShare/userApplyDownListToJsp.action?applyState=3&applyTitle=常规数据下载记录">常规数据下载记录</a></li>
								<li class="u04"><a href="javascript:;" rel="/DataShare/earthQuake/userEventListToJsp.action?applyTitle=应急数据下载记录">应急数据下载记录</a></li>
                            </ul>
                        </ul>
					</div>
					<!--  ==右侧功能区==  -->
					...
					<script>
						showtime();
						var url="/DataShare/querUserSelfToJsp.action?applyTitle=个人信息";
						$("#iframe").attr("src",url);
						var w;
