    ...
    <div class="CenterP-main">
       ...
       <div class="leftbar_top"><h3>共享指南</h3></div>
        ...
        <div id="menu">
	        ...
	        <h1 onClick="javascript:ShowMenu(this,'NO2')" id="c_12"><a href="/DataShare/index.action?id=62" class="active">数据介绍</a></h1>
        </div>
        ...
        <div class="CenterP-right">
            <div class="CenterP-right-header">
                <div class="header-tit">数据介绍</div>
                <div class="header-nav"><a href="/DataShare/index.action?id=1">主页></a><a href="/DataShare/index.action?id=6">共享指南></a><a href="/DataShare/index.action?id=6" class="onactive">数据介绍</a></div>
            </div>
            <div class="CenterP-right-content">
              GNSS数据资源共享与信息发布平台 数据源包括：陆态网络30秒日常数据、陆态网络地震应急数据、陆态网络流动观测数据、全国GNSS数据资源共享数据、站点大事记和其他数据等。
            </div>
