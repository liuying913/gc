	$(document).ready(function() {
			...
			var isFlag=$("#userId").val();
	  		...
	  		var url = "/AlarmPlatForm/alarmSendSearch/queryAlarmInfoList.action?startTime="+startTime+"&endTime="+endTime+"&isFlag="+isFlag+"&pageSize="+pageSize;
			...
			$(".seabtn").click(function() {
				...
				var startTime = getMonthOne();
		  		var endTime = getToday();
				ajaxRequest("/AlarmPlatForm/alarmSendSearch/queryAlarmInfoList.action?startTime="+startTime+"&endTime="+endTime + "&currentPage=" + currentPage+"&isFlag="+isFlag+"&pageSize="+pageSize,"get", function(res) {
					var JSONObj = res;
					currentPage = JSONObj[0].currentPage;
					pageCount = JSONObj[0].pageCount;
					recordCount = JSONObj[0].recordCount;
	...
	function searchpage(currentPage) {
		...
		var startTime = getMonthOne();
  		var endTime = getToday();
		ajaxRequest("/AlarmPlatForm/alarmSendSearch/queryAlarmInfoList.action?startTime="+startTime+"&endTime="+endTime + "&currentPage=" + currentPage+"&isFlag="+isFlag+"&pageSize="+pageSize, "get",
				function(res) {
					var JSONObj = res;
					currentPage = JSONObj[0].currentPage;
					pageCount = JSONObj[0].pageCount;
