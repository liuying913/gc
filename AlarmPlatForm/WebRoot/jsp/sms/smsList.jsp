...
<head>
    ...
    <script type="text/javascript" src="/AlarmPlatForm/jsp/sms/userdownHistoryList.js"></script>
</head>
...
<body>
  ...
  var pageSize = 10;
	...
	$('#excel').click(function() {
		...
		var url = "/AlarmPlatForm/smsSendSearch/dataExcel.action?isFlag="+isFlag+"&startTime="+startTime+"&endTime="+endTime+"&pageSize=100000";
