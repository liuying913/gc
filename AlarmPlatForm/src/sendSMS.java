...
public class sendSMS {
	public static void main(String[] args) {
		...
		String username = "yuanguang";  //用户名
		
		String password_md5 = "6572bdaff799084b973320f43f09b363";  //密码
		
		String mobile = "18500879902,15510566647,15811019428";  //手机号,只发一个号码：13800000001。发多个号码：13800000001,13800000002,...N 。使用半角逗号分隔。
		                 
		String apikey = "fdb227bc3047b9e17b56ca7dfef41d06";  //apikey秘钥（请登录 http://m.5c.com.cn 短信平台-->账号管理-->我的信息 中复制apikey）
		
		String content = "您好，我是刘颖，通过短信这种形式，发现价格最低能达到5分钱到六分钱一条，时间上没有限制，发完为止！";  //要发送的短信内容，特别注意：签名必须设置，网页验证码应用需要加添加【图形识别码】。
