...
<head>
    ...
    <style>
        .newstable-content .newlist {
            font-size: 13px; padding: 20px 0 20px 0px; display: inline-block; margin-top: -10px;
            width: 100%;
        }
        .newlist li{
            line-height: 30px;
...
<body>
            ...
            <div class="newstable-content">
                <div class="newstable-fy">
                    <div class="newstable-fy-pages">
                        <span>共<font id="zongyeshu">1</font>页&nbsp;&nbsp;<font id="zongshuju">4</font>条记录</span>
                        <a href="javascript:void(0)" onclick="yeshu(1)">首页</a>
                        <a href="javascript:void(0)" id="prevpage" onclick="shang();">上一页</a>
                        <span class="everypages"><a href="javascript:void(0)" onclick="yeshu(this)">1</a></span>
    ...
    <script src="/DataShare/js/page.js" type="text/javascript" charset="utf-8"></script>
    <script>		
        $.ajaxSetup({ cache: false });//全局禁用缓存
        window.onload=function(){
            pages("/DataShare/news/getNewsInfoList.action?type=1");
        }
    </script>
</body>
</html>
